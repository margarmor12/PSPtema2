 ...
 */
public class U2A7_ObtenerDireccionesIp {
        ...
        try {          
            ...
            if (valorSalidaProceso != 0) {
                ...
                while ((linea = salidaProceso.readLine()) != null) {
                    // Descartamos las líneas que no contengan el texto "IPv4"
                    if (linea.indexOf("IPv4") != -1) { 
                        // Busco la última aparición del caracter ":" en la línea
                        // Muestro desde la siguiente posición hasta el final de la línea
                        System.out.println(linea.substring(linea.lastIndexOf(":")+1).trim());
                    }
                }            
            }
